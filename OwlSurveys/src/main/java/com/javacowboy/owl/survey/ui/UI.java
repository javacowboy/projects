...
public class UI {
	...
	public static void createAndShowGui(ActionListener runActionListener) {
		...
		frame.getContentPane().setLayout(new GridLayout(5, 1));//rows, columns
	...
	private static void inputSection(final JFrame parent) {
		...
		final JLabel selectedDirectoryLabel = new JLabel(Property.INPUT_DIRECTORY.getPropertyValue());
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JFileChooser fileChooser = createFileChooser(parent, selectedDirectoryLabel, directory);
	...
	private static void outputSection(final JFrame parent) {
		...
		//show currently selected directory
		final JLabel selectedDirectoryLabel = new JLabel(Property.OUTPUT_DIRECTORY.getPropertyValue());
	...
	protected static JFileChooser createFileChooser(JFrame parent, JLabel label, String defaultLocation) {
